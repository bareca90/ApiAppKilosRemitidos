...
import { GetWaybillValidation, UpdateDateTimeWaybillValidation } from "./data.validations";  
import { getWaybillController, updateDateTimeWaybillController } from "./data.controller";
